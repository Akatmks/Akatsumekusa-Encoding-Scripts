...
def adaptive_grain(
    ...
    dynamic_high_removal: float = 1.1,
    static_high_addition: float = 1.6,
    **kwargs,
) -> vs.VideoNode:
    """
    ...
    grained = grained.dctf.DCTFilter(factors=inter_factor(dynamic_high_removal))
    ...
    lowpassed_static_grained = static_grained.dctf.DCTFilter(factors=intra_factor(static_high_addition))
